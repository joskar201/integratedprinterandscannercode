...
public abstract class BarcodeCreater {
	 ...
	 *            Generated inside
	 * @param desiredWidth
	 *            Generate barcode broadband
	 * @param desiredHeight
	 *            Generate the height of the barcode
	 * @param displayCode
	 *            Whether to display content below the barcode
	 * @return
	 */
	...
	/**
	 * Generate a display map of the Bitmap
	 * 
	 * @param contents
	 * @param width
	 * @param height
	...
	/**
	 * Generate a barcode for the Bitmap
	 * 
	 * @param contents
	 *            Generated inside
	 * @param
	 ...
	 * @param second
	 * @param fromPoint
	 *            Second Bitmap (The starting position of the drawing（Relative to the first Bitmap)
	 * @return
	 */
	...
	public static Bitmap encodeAsBitmap(String contents, BarcodeFormat format,
		...
		final int WHITE = 0xFFFFFFFF; // Can specify other colors，Make QR code color effect
